        ...
        case MOTORS_AO_CALIB_M1_ST:{        // MOTOR 1 Calibration
            ...
            switch(e->sig){
                case MOTORS_AO_TIMEOUT_SIG:{
                    ...
                    Active_post(AO_blinkyButton, (Event*)&angle1_ack);
            ...
            switch(e->sig){
                case MOTORS_AO_TIMEOUT_SIG:{
                    ...
                    Active_post(AO_blinkyButton, (Event*)&angle2_ack);
        ...
        case MOTORS_AO_WAITING_ST:{
            switch(e->sig){
                ...
                case MOTORS_AO_MOVE_SIG:{   // TODO: Motion profile precalculation
                    int16_t deg_to_move = ((MOTORS_AO_MOVE_PL*)e)->degrees;
            ...
            switch(e->sig){
                case MOTORS_AO_TIMEOUT_SIG:{
                    if(this->movement_steps<MOTOR2_MOVEMENT_STEPS){
                        ...
                        Active_post(AO_blinkyButton, (Event*)&move_m2_ack);
