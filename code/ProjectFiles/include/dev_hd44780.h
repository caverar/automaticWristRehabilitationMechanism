...
#define init_wait_ms(ms) busy_wait_ms(ms)
#define init_wait_us(us) busy_wait_us(us)
#define running_wait_ms(ms) vTaskDelay(ms)
#define running_wait_us(us) busy_wait_us(us)
